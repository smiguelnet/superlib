  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="superlibApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Title" id="category-title" name="title" data-cy="title" type="text" />
